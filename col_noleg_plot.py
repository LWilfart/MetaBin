...
# Votre liste de couleurs personnalisée
...
# Enregistrer la légende en tant qu'image
legend_fig = plt.figure(figsize=(2, 8))  # Ajustez la taille de la figure de la légende
plt.legend(handles=legend_patches, title='Code', loc='center')
plt.axis('off')  # Désactiver les axes pour la légende
legend_fig.savefig('legend.png', bbox_inches='tight')  # Enregistrer la légende en tant qu'image
plt.close(legend_fig)  # Fermer la figure de la légende pour ne pas l'afficher
